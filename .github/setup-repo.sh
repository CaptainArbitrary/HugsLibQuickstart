...
gh variable set SLN_PATH -b "Source/Assemblies/$MOD_NAME/$MOD_NAME.sln"
gh variable set CSPROJ_PATH -b "Source/Assemblies/$MOD_NAME/$MOD_NAME/$MOD_NAME.csproj"
gh variable set ASSEMBLY_PATH -b "1.4/Assemblies/$MOD_NAME.dll"
gh variable set ZIP_CONTENTS -b "1.4/ About/ Textures/ LICENSE"
